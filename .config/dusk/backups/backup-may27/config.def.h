/*pdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqppdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqppd
...
static const int scalepreview            = 2;   /* size of workspace previews compared to monitor size */
...
static char dmenunormbgcolor[] = "#181818";
...
static char *colors[SchemeLast][ColCount] = {
	...
	[SchemeNorm]         = { "#fff7d4", "#282828", "#444444", "norm" },// main title bar color
	[SchemeSel]          = { "#FFF7D4", "#ff557f", "#ff557f", "sel" },
	[SchemeTitleNorm]    = { "#C6BDBD", "#000000", "#1a1a1a", "titlenorm" },//surrounds the border of bar when empty workspace
    [SchemeTitleSel]     = { "#FFF7D4", "#55ffff", "#ff0000", "titlesel" },
	[SchemeWsNorm]       = { "#787878", "#0b0b0b", "#0b0b0b", "wsnorm" },// workspace empty
	[SchemeWsVisible]    = { "#000000", "#9d9d9d", "#ffffff", "wsvis" },// layout indicator
	[SchemeWsSel]        = { "#121212", "#cfa96e", "#000000", "wssel" },// active workspace selection indication
	[SchemeWsOcc]        = { "#ffffff", "#272727", "#000000", "wsocc" },// workspaces with open items
	[SchemeHidNorm]      = { "#AD1C56", "#222222", "#000000", "hidnorm" },
	[SchemeHidSel]       = { "#D288C6", "#111111", "#14F30F", "hidsel" },
	[SchemeUrg]          = { "#bbbbbb", "#222222", "#d10f3f", "urg" },
	[SchemeMarked]       = { "#615656", "#ECB820", "#ECB820", "marked" },
	[SchemeScratchNorm]  = { "#FFF7D4", "#219475", "#020011", "scratchnorm" },//bar text - bottom bar - inactive window border
	[SchemeScratchSel]   = { "#07F811", "#C935E4", "#AD1C56", "scratchsel" },// bar text -  bottom bar - active window border 
	[SchemeFlexActTTB]   = { "#FFF7D4", "#080707", "#080707", "actTTB" },
	[SchemeFlexActLTR]   = { "#FFF7D4", "#440044", "#440044", "actLTR" },
	[SchemeFlexActMONO]  = { "#FFF7D4", "#000044", "#000044", "actMONO" },
	[SchemeFlexActGRID]  = { "#FFF7D4", "#cb1b04", "#cb1b04", "actGRID" },
	[SchemeFlexActGRIDC] = { "#FFF7D4", "#cb1b04", "#cb1b04", "actGRIDC" },
	[SchemeFlexActGRD1]  = { "#FFF7D4", "#cb1b04", "#cb1b04", "actGRD1" },
	[SchemeFlexActGRD2]  = { "#FFF7D4", "#cb1b04", "#cb1b04", "actGRD2" },
	...
	[SchemeFlexActFloat] = { "#FFF7D4", "#0da28c", "#0da28c", "actfloat" },
	[SchemeFlexInaTTB]   = { "#C6BDBD", "#080707", "#080707", "normTTB" },
	...
	[SchemeFlexInaFloat] = { "#C6BDBD", "#0da28c", "#0da28c", "normfloat" },
	[SchemeFlexSelTTB]   = { "#FFF7D4", "#cba366", "#cc231c", "selTTB" },// active workspace - letter color- top bar - surrounding border of active work space
	...
	[SchemeFlexSelFloat] = { "#FFF7D4", "#0da28c", "#0da28c", "selfloat" },
};
...
//	{ .class = "Arcologout.py", .flags = AlwaysOnTop|Centered },
	...
	{ .instance = "spterm (r)", .scratchkey = 'r', .flags = Floating },
...
//	{ .class = "firefox"       , .workspace = "NULL"  },
      //{ .role = "firefox"        , .workspace = "2", .flags = AttachBelow|OnlyModButtons|SwitchWorkspace },
...
//	{ .class = "Kitty"         , .flags = AlwaysOnTop|Centered|Floating },
...
static const BarDef bars[] = {
	...
	{  1,      0,   0,    "0%    0%     100% -1h ", "Primary top" },
	{  1,      1,   0,    "0%    100%   100% -1h ", "Primary bottom" },
...
static const WorkspaceRule wsrules[] = {
	...
	{  "1",     -1,       0,       0,       -1,     2,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "1",   "",   "[1]", },
	{  "2",     -1,       0,       0,       -1,     2,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "2",   "",   "[2]", },
	{  "3",     -1,       0,       0,       -1,     2,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "3",   "",   "[3]", },
	...
	{  "6",     -1,       0,      14,      .70,     2,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "6",   "",   "[6]", },
	{  "7",     -1,       0,      10,      .60,    -1,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "7",   "",   "[7]", },
	{  "8",      0,       1,      07,      .70,     1,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "8",   "",   "[8]", },
	{  "9",      0,       0,       0,       -1,     2,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "",   "",   "[9]", },
//{  "5",     -1,       0,       5,      .80,     1,       -1,      -1,
...
static const Layout layouts[] = {
	/* symbol   arrange function, {    nmaster, nstack,         layout,              master axis,          stack axis, second stack axis, symbol func } */
...
//static const char *kittycmd[]  = { NULL, "kitty", NULL };
static const char *kitty2cmd[]  = { NULL, "kitty","--config","/home/trg/.config/kitty/kitty2.conf", NULL };
static const char *firefoxcmd[]  = { NULL, "firefox", NULL };
static const char *fileman[]  = { NULL, "pcmanfm", NULL };
static const char *katecmd[]  = { NULL, "featherpad", NULL };
...
static const char *sshotcmd[] = { NULL, "./scripts/flameshot.sh", NULL };
...
static Key keys[] = {
	...
	{ KeyPress,   MODKEY,                       XK_Print,        spawn,                  {.v = sshotcmd } },

	{ KeyPress,   MODKEY,                       XK_d,            spawn,                  {.v = dmenucmd } },  /*spawn dmenu for launching other programs */
	{ KeyPress,   MODKEY,                       XK_Return,       spawn,                  {.v = kitty2cmd } }, // spawn a terminal
	{ KeyPress,   MODKEY|Shift,                 XK_Return,       riospawn,               {.v = termcmd } }, // draw/spawn a terminal
	{ KeyPress,   MODKEY|Shift,                 XK_e,            spawn,                  {.v = fileman } }, // draw/spawn a file manager
	{ KeyPress,   MODKEY|Shift,                 XK_s,            spawn,                  {.v = firefoxcmd } }, // draw/spawn a web firefox
	{ KeyPress,   MODKEY|Shift,                 XK_w,            spawn,                  {.v = katecmd } }, // draw/spawn a kate
