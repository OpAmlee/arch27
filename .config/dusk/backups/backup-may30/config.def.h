...
static unsigned int attachdefault        = AttachBottom; // AttachMaster, AttachAbove, AttachAside, AttachBelow, AttachBottom
...
static const int scalepreview            = 8;   /* size of workspace previews compared to monitor size */
...
static char *colors[SchemeLast][ColCount] = {
	...
	[SchemeNorm]         = { "#fff7d4", "#121212", "#444444", "norm" },// main title bar color
	...
	[SchemeWsVisible]    = { "#000000", "#E1D2AA", "#ffffff", "wsvis" },// layout indicator
	...
	[SchemeFlexActLTR]   = { "#FFF7D4", "#440044", "#F00890", "actLTR" },
	...
	[SchemeFlexSelTTB]   = { "#0B0A09", "#005F87", "#B70BA7", "selTTB" },// active workspace - letter color- top bar - surrounding border of active work space
...
static const Rule clientrules[] = {
	...
	{ .instance = "spterm (r)", .scratchkey = 'r'  , .floatpos ="30% 30%",  },
	...
	{ .class    = "firefox"              , .workspace  = "NULL", .flags = IgnoreCfgReqPos },
	{ .class    = "Google-chrome-stable" , .role       = "GtkFileChooserDialog", .floatpos = "50% 50%", .flags = AlwaysOnTop|Floating },
...
static const BarDef bars[] = {
	...
	{  1,      1,   0,    "0%    100%   100% 15h ", "Secondary bottom" },
	{  2,      0,   0,    "0%    0%     100% -1h ", "Tertiary top" },
	{  2,      1,   0,    "0%    100%   100% 30h ", "Tertiary bottom" },
...
static const WorkspaceRule wsrules[] = {
	...
	{  "1",      1,      -1,       0,       -1,     1,        2,       1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "1",   "",   "(1)", }, 
	{  "2",      1,      -1,      14,      .70,     2,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "2",   "",   "(2)", },
	{  "3",      1,      -1,       4,       -1,     2,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "3",   "",   "(3)", },
	{  "4",      1,      -1,       5,       -1,    -1,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "4",   "",   "(4)", },
	...
	{  "9",      0,       1,       0,       -1,     2,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "9",  "",    "" , },
//{  "5",     -1,       0,       5,      .80,     1,       -1,      -1,
...
static const char *term2cmd[]  = { NULL, "kitty","--config","/home/trg/.config/kitty/kitty2.conf", NULL };
...
static Key keys[] = {
    ...
    { KeyPress,   ALTKEY,                       XK_e,            spawn,                  {.v = fmcmd } },        // draw/spawn a file manager
