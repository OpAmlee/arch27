...
static char *colors[SchemeLast][ColCount] = {
	...
	[SchemeWsOcc]        = { "#E8D9B1", "#121212", "#000000", "wsocc" },// util bar icon color background of workspaces with open items
	...
	[SchemeFlexActGRID]  = { "#E8D9B1", "#cb1b04", "#cb1b04", "actGRID" },
	[SchemeFlexActGRIDC] = { "#E8D9B1", "#cb1b04", "#cb1b04", "actGRIDC" },
	[SchemeFlexActGRD1]  = { "#E8D9B1", "#cb1b04", "#cb1b04", "actGRD1" },
	[SchemeFlexActGRD2]  = { "#E8D9B1", "#cb1b04", "#cb1b04", "actGRD2" },
	[SchemeFlexActGRDM]  = { "#E8D9B1", "#507711", "#507711", "actGRDM" },
	[SchemeFlexActHGRD]  = { "#E8D9B1", "#b97711", "#b97711", "actHGRD" },
	[SchemeFlexActDWDL]  = { "#E8D9B1", "#004444", "#004444", "actDWDL" },
	[SchemeFlexActDWDLC] = { "#E8D9B1", "#004444", "#004444", "actDWDLC" },
	[SchemeFlexActSPRL]  = { "#E8D9B1", "#444400", "#444400", "actSPRL" },
	[SchemeFlexActSPRLC] = { "#E8D9B1", "#444400", "#444400", "actSPRLC" },
	[SchemeFlexActTTMI]  = { "#E8D9B1", "#B81616", "#B81616", "actTTMI" },
	[SchemeFlexActTTMIC] = { "#E8D9B1", "#B81616", "#B81616", "actTTMIC" },
	[SchemeFlexActFloat] = { "#E8D9B1", "#9B2E2E", "#121212", "actfloat" },  //unknown - focused - unfocused - window border for toggle center
	[SchemeFlexInaTTB]   = { "#E8D9B1", "#080707", "#080707", "normTTB" },
	[SchemeFlexInaLTR]   = { "#E8D9B1", "#330033", "#330033", "normLTR" },
	[SchemeFlexInaMONO]  = { "#E8D9B1", "#000033", "#000033", "normMONO" },
	[SchemeFlexInaGRID]  = { "#E8D9B1", "#003300", "#003300", "normGRID" },
	[SchemeFlexInaGRIDC] = { "#E8D9B1", "#003300", "#003300", "normGRIDC" },
	[SchemeFlexInaGRD1]  = { "#E8D9B1", "#003300", "#003300", "normGRD1" },
	[SchemeFlexInaGRD2]  = { "#E8D9B1", "#003300", "#003300", "normGRD2" },
	[SchemeFlexInaGRDM]  = { "#E8D9B1", "#506600", "#506600", "normGRDM" },
	[SchemeFlexInaHGRD]  = { "#E8D9B1", "#b96600", "#b96600", "normHGRD" },
	[SchemeFlexInaDWDL]  = { "#E8D9B1", "#003333", "#003333", "normDWDL" },
	[SchemeFlexInaDWDLC] = { "#E8D9B1", "#003333", "#003333", "normDWDLC" },
	...
	[SchemeFlexSelGRID]  = { "#E8D9B1", "#005500", "#005500", "selGRID" },
	[SchemeFlexSelGRIDC] = { "#E8D9B1", "#005500", "#005500", "selGRIDC" },
	[SchemeFlexSelGRD1]  = { "#E8D9B1", "#005500", "#005500", "selGRD1" },
	[SchemeFlexSelGRD2]  = { "#E8D9B1", "#005500", "#005500", "selGRD2" },
	[SchemeFlexSelGRDM]  = { "#E8D9B1", "#508822", "#508822", "selGRDM" },
	[SchemeFlexSelHGRD]  = { "#E8D9B1", "#b98822", "#b98822", "selHGRD" },
	[SchemeFlexSelDWDL]  = { "#E8D9B1", "#005555", "#005555", "selDWDL" },
	[SchemeFlexSelDWDLC] = { "#E8D9B1", "#005555", "#005555", "selDWDLC" },
...
//	{ .class = "st"            , .flags = NoSwallow},
    ...
    { .class = "copyq"         , .flags = Floating|Centered },
// class role instance title wintype opacity flags floatpos scratchkey workspace
...
/*  WorkspaceRule wsrules legend {{{3   
 |===========================================================================================================|=====================|
 ...
 |==================================================|     default,         visible,    selected,    occupied, def,  vac,     occ, }}}*/
    {  "1",   0,    1,    0,   -1,    2,    3,   -1, SchemeWsNorm, SchemeWsVisible, SchemeWsSel, SchemeWsOcc, "ﳐ",   "",   "ﳐ", },
	{  "2",   0,    0,   14,  .70,    2,   -1,   -1, SchemeWsNorm, SchemeWsVisible, SchemeWsSel, SchemeWsOcc, "",   "",   "", },
	{  "3",   0,    1,    1,   -1,    3,   -1,   -1, SchemeWsNorm, SchemeWsVisible, SchemeWsSel, SchemeWsOcc, "",   "",   "", },
	{  "4",   0,    1,    0,   -1,   -1,   -1,   -1, SchemeWsNorm, SchemeWsVisible, SchemeWsSel, SchemeWsOcc, "",   "",   "", },
	{  "5",   0,    0,   11,   -1,    1,   -1,   -1, SchemeWsNorm, SchemeWsVisible, SchemeWsSel, SchemeWsOcc, "",   "",   "", },
	{  "6",   0,    0,   14,  .70,    2,   -1,   -1, SchemeWsNorm, SchemeWsVisible, SchemeWsSel, SchemeWsOcc, "",   "",   "", },
	{  "7",   0,    0,   10,  .60,   -1,   -1,   -1, SchemeWsNorm, SchemeWsVisible, SchemeWsSel, SchemeWsOcc, "",   "",   "", },
	{  "8",   0,    0,   07,  .70,    1,   -1,   -1, SchemeWsNorm, SchemeWsVisible, SchemeWsSel, SchemeWsOcc, "",   "",   "", },
	{  "9",   0,    0,    0,   -1,    2,   -1,   -1, SchemeWsNorm, SchemeWsVisible, SchemeWsSel, SchemeWsOcc, "",   "",   "", },
};
...
static const char *termcmd[]  = { NULL, "kitty","--config","/home/trg/.config/kitty/kitty2-standard.conf", NULL };
...
{ KeyPress,   MODKEY|ControlMask,   XK_Left,   focusdir, {.i = 0 } }, // focus on the client left of the currently focused client
{ KeyPress,   MODKEY|ControlMask,   XK_Right,  focusdir, {.i = 1 } }, // focus on the client right of the currently focused client
{ KeyPress,   MODKEY|ControlMask,   XK_Up,     focusdir, {.i = 2 } }, // focus on the client above the currently focused client
{ KeyPress,   MODKEY|ControlMask,   XK_Down,   focusdir, {.i = 3 } }, // focus on the client below the currently focuse
/*}}}*/
