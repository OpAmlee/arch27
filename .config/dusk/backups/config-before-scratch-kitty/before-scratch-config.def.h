...
pdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqppdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqpdbqppd*/
//checking update on gitlab
// COMMENTS - edit this file - add change log time stamp
/*
 * ╔═╗╦ ╦╔═╗╔╗╔╔═╗╔═╗  ╦  ╔═╗╔═╗
   ║  ╠═╣╠═╣║║║║ ╦║╣   ║  ║ ║║ ╦
   ╚═╝╩ ╩╩ ╩╝╚╝╚═╝╚═╝  ╩═╝╚═╝╚═╝ change-log notes with time stamps
...
static char *colors[SchemeLast][ColCount] = {
	...
	[SchemeNorm]         = { "#BE89AE", "#080707", "#444444", "norm" },
	[SchemeSel]          = { "#FFF7D4", "#440000", "#440000", "sel" },
	[SchemeTitleNorm]    = { "#C6BDBD", "#080707", "#080707", "titlenorm" },
	[SchemeTitleSel]     = { "#FFF7D4", "#440000", "#440000", "titlesel" },
	[SchemeWsNorm]       = { "#BE89AE", "#080707", "#000000", "wsnorm" },
	[SchemeWsVisible]    = { "#BE89AE", "#5E294B", "#000000", "wsvis" },
	[SchemeWsSel]        = { "#D8B2CD", "#6F3A5C", "#000000", "wssel" },
	[SchemeWsOcc]        = { "#BE89AE", "#080707", "#000000", "wsocc" },
...
static const Rule clientrules[] = {
	...
	*/
	...
	//{ .class = "browser", .workspace = "2", .flags = AttachMaster|SwitchWorkspace },
	...
	{ .class = "Yad", .flags = AlwaysOnTop|Floating|Centered },
...
//	{  "2",     -1,       0,       0,       -1,    -1,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "2",   "",   "[2]", },
	...
	{  "4",     -1,       0,       8,       -1,    -1,       -1,      -1,     SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "4",   "",   "[4]", },
	...
	{  "2",     -1,       0,       6,      .60,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "8",   "",   "[8]", },
...
static const Layout layouts[] = {
    ...
    /*01*/{ "[]=",      flextile,         { -1, -1, SPLIT_VERTICAL, TOP_TO_BOTTOM, TOP_TO_BOTTOM, 0, NULL } }, // default tile layout
	/*02*/{ "|||",      flextile,         { -1, -1, NO_SPLIT, LEFT_TO_RIGHT, LEFT_TO_RIGHT, 0, NULL } }, // columns
	/*03*/{ "===",      flextile,         { -1, -1, NO_SPLIT, TOP_TO_BOTTOM, TOP_TO_BOTTOM, 0, NULL } }, // rows
	/*04*/{ "[M]",      flextile,         { -1, -1, NO_SPLIT, MONOCLE, MONOCLE, 0, NULL } }, // monocle
	/*05*/{ "||=",      flextile,         { -1, -1, SPLIT_VERTICAL, LEFT_TO_RIGHT, TOP_TO_BOTTOM, 0, NULL } }, // columns (col) layout
	/*06*/{ ">M>",      flextile,         { -1, -1, FLOATING_MASTER, LEFT_TO_RIGHT, LEFT_TO_RIGHT, 0, NULL } }, // floating master
	/*07*/{ "[D]",      flextile,         { -1, -1, SPLIT_VERTICAL, TOP_TO_BOTTOM, MONOCLE, 0, NULL } }, // deck
	/*08*/{ "TTT",      flextile,         { -1, -1, SPLIT_HORIZONTAL, LEFT_TO_RIGHT, LEFT_TO_RIGHT, 0, NULL } }, // bstack
	/*09*/{ "===",      flextile,         { -1, -1, SPLIT_HORIZONTAL, LEFT_TO_RIGHT, TOP_TO_BOTTOM, 0, NULL } }, // bstackhoriz
	/*10*/{ "==#",      flextile,         { -1, -1, SPLIT_HORIZONTAL, TOP_TO_BOTTOM, GAPPLESSGRID_CFACTS, 0, NULL } }, // bstackgrid
	/*11*/{ "|M|",      flextile,         { -1, -1, SPLIT_CENTERED_VERTICAL, LEFT_TO_RIGHT, TOP_TO_BOTTOM, TOP_TO_BOTTOM, NULL } }, // centeredmaster
	/*12*/{ "-M-",      flextile,         { -1, -1, SPLIT_CENTERED_HORIZONTAL, TOP_TO_BOTTOM, LEFT_TO_RIGHT, LEFT_TO_RIGHT, NULL } }, // centeredmaster horiz
	/*13*/{ ":::",      flextile,         { -1, -1, NO_SPLIT, GAPPLESSGRID_CFACTS, GAPPLESSGRID_CFACTS, 0, NULL } }, // gappless grid
	/*14*/{ "[\\]",     flextile,         { -1, -1, NO_SPLIT, DWINDLE_CFACTS, DWINDLE_CFACTS, 0, NULL } }, // fibonacci dwindle
	/*15*/{ "(@)",      flextile,         { -1, -1, NO_SPLIT, SPIRAL_CFACTS, SPIRAL_CFACTS, 0, NULL } }, // fibonacci spiral
	/*16*/{ "[T]",      flextile,         { -1, -1, SPLIT_VERTICAL, LEFT_TO_RIGHT, TATAMI_CFACTS, 0, NULL } }, // tatami mats
    /*17*/{ "><>",      NULL,             {0} },    /* no layout function means floating behavior */
	/*18*/{ NULL,       NULL,             {0} },    /* end of layouts marker for cyclelayouts */
};
...
static const char *katecmd[]  = { NULL, "kate", NULL };
...
static const char *spcmd_r[] = {"r", "st", "-n", "spfm (r)", "-g", "100x15", "-e", "ranger", NULL };
...
//	{ KeyPress,   MODKEY|Ctrl,                  XK_n,            spawn,                  {.v = notecmd } }, // draw/spawn a notepad

	{ KeyPress,   MODKEY|Shift,                 XK_e,            spawn,                  {.v = fileman } }, // draw/spawn a file manager
	{ KeyPress,   Alt,                          XK_f,            spawn,                  {.v = browser } }, // draw/spawn a web browser
	{ KeyPress,   MODKEY|Ctrl,                  XK_m,            spawn,                  {.v = katecmd } }, // draw/spawn a kate
