...
/*
 * background image
 * expects farbfeld format not sure if it will update
 * pseudo transparency fixes coordinates to the screen origin
 */
static const char *bgfile = "~/.config/dwmtrg/st/backgrounds/kitty-bg.png";
...
//	"#1d2021", // default contrast #282828# hard contrast: #1d2021 / soft contrast: #32302f 
//	"#cc241d",
//	"#98971a",
//	"#d79921",
//	"#458588",
