#+TITLE: TRG's Doom Emacs Config
#+PROPERTY: header-args :tangle ~/.config/doom/config.el
#+AUTHOR: original author Derek Taylor (DT)
#+DESCRIPTION: TRG's personal Doom Emacs config. Structure borrow from Derek Taylor @ distrotube
