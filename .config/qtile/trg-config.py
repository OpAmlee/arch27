...
##+++++++++++++++++++++++++++++++++++++++++++##
## QTILE CONFIG BY AXYL MODIFIED BY ADAM LEE ##
##+++++++++++++++++++++++++++++++++++++++++++##
...
def init_widgets_list():
    widgets_list = [
            ...
            space,
            widget.Image(
                filename = "/home/trg/.config/kitty/icons/whiskers/whiskers-tokyo.png",
                background = colors[1],
                margin = 3,
                mouse_callbacks = {
                    ...
                    'Button3': lambda : qtile.cmd_spawn(
                        ...
                        "sudo kitty -c ~/.config/kitty/kitty.conf"
                    )
                }
            ),
            widget.Image(
                filename = "/home/trg/.config/qtile/python.png",
                background = colors[1],
                margin = 3,
                mouse_callbacks = {
                    'Button1': lambda : qtile.cmd_spawn(
